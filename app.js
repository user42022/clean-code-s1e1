...
var editTask=function(){
    ...
    label.classList.toggle("task-label_edit-mode")
    editInput.classList.toggle("task-input_edit-mode")
};
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.querySelector(".task-label").classList.toggle("task-label_completed")
